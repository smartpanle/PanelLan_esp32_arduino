/*
    The library comes from:<Arduino-AW9523B>
    github:https://github.com/aselectroworks/Arduino-AW9523B.git
*/
...
#define AW9523B_I2C_PORT  (1)       // 0:I2C_NUM_0 1:I2C_NUM_1
#define AW9523B_I2C_FREQ  (400000)

// Device Address
#define AW9523B_I2C_BASE_ADDRESS 0x5B // 7-bit Address
// Register Address
...
#ifdef AW9523B_DEBUG
#define DEBUG_PRINT(...) \
    { DEBUG_PRINTER.printf("[AW9523B(0x%02x)]: ", AW9523B_I2C_BASE_ADDRESS); DEBUG_PRINTER.print(__VA_ARGS__); }
#define DEBUG_PRINTLN(...) \
    { DEBUG_PRINTER.printf("[AW9523B(0x%02x)]: ", AW9523B_I2C_BASE_ADDRESS); DEBUG_PRINTER.println(__VA_ARGS__); }
#else
#define DEBUG_PRINT(...) {}
#define DEBUG_PRINTLN(...) {}
#endif
